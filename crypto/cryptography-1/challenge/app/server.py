...
if __name__ == '__main__':
    try:
        ...
        print("[!] Answer 50 queries to get the flag. In each query, input the shortest path decrypted from response. It will be a string of space-separated nodes from source to destination, e.g. '1 2 3 4'.")
        for q in range(50):
            while True:
